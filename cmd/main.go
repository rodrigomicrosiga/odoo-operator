...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a17bc677.cloud104.io",
	...
	if err := (&controller.OdooInstanceReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "odooinstance")
		os.Exit(1)
	}
	if err := (&controller.OdooDatabaseReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "odoodatabase")
		os.Exit(1)
	}
