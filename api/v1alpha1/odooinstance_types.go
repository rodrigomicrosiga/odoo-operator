...
type OdooInstanceSpec struct {
	...
	// foo is an example field of OdooInstance. Edit odooinstance_types.go to remove/update
	// +optional
...
type OdooInstanceStatus struct {
	...
	// conditions represent the current state of the OdooInstance resource.
...
type OdooInstance struct {
	...
	// spec defines the desired state of OdooInstance
	// +required
	Spec OdooInstanceSpec `json:"spec"`

	// status defines the observed state of OdooInstance
	// +optional
